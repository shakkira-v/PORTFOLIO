...
import prof1 from "../assets/bgpro13.png";
  ...
  return (
    <section
      ...
      className="relative min-h-screen w-full flex flex-col md:flex-row justify-between items-center 
                 ...
                 bg-gradient-to-br from-[#000000] via-[#000000] to-[#96365fff]"
    >
      ...
      {/* Floating Square */}
      <motion.div
        className="absolute bottom-28 right-16 w-14 h-14 bg-blue-400/40 rotate-45 blur-md"
      ...
      <motion.div
        className="absolute top-1/2 right-1/3 w-0 h-0 
                   ...
                   border-l-transparent border-r-transparent border-b-pink-500/50"
      ...
      <motion.div
        className="absolute top-[-100px] left-[-80px] w-72 h-72 
                   bg-purple-600/40 rounded-full blur-3xl"
      ...
      <motion.div
        className="absolute top-1/3 left-1/2 -translate-x-1/2 w-64 h-64 
                   bg-fuchsia-600/30 rounded-full blur-[100px]"
...
>
  ...
  />
        ...
        <motion.button
          whileHover={{ scale: 1.05, boxShadow: "0px 4px 15px rgba(236,72,153,0.3)" }}
          whileTap={{ scale: 0.95 }}
        ...
        >
          <a href="https://www.linkedin.com/in/shakkira-v-115b9136b/" className="hover:text-pink-500 transition"><FaLinkedin /></a>
          <a href="https://github.com/" className="hover:text-pink-500 transition"><FaGithub /></a>
      ...
      >
        <div className="w-[18rem] md:w-[24rem] lg:w-[28rem] p-2 rounded-full bg-gradient-to-br from-sky-950 to-red-900">
          <img
            src={prof1}
            className="rounded-full object-cover w-full h-full hover:scale-125 transition duration-700"
            alt="Profile"
          />
        </div>
      </motion.div>
